<template>
  <div class="home-header fromTop ae-1 do">
    ...
    <ul class="center" ref="ulRef">
      <li v-for="(item, index) in menuList" :key="item.id" :class="['menu-item', {active: index === currentItem}]" @mouseenter="mouseenterHandler" @mouseleave="mouseleaveHandler">
        {{item.title}}
      </li>
    </ul>
    <div class=" right">
...
const menuList = [
  ...
  { id: 2, title: 'AGA', routeName: '', href: '' },
  { id: 3, title: 'DEVELOPER', routeName: 'Developer', href: '' },
  { id: 4, title: 'COMMUNITY', routeName: 'Community', href: '' },
  { id: 5, title: 'TOKENOMICS', routeName: 'Tokenomics', href: '' },
